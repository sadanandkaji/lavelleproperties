  ...
  return (
    ...
    <div className="relative z-10 mt-20 w-full max-w-[800px] px-4 text-center">
      ...
      <button 
        ...
        className="fixed left-4 top-26 z-50 flex h-10 w-10 items-center justify-center rounded-full border border-[#d4af3744] bg-white/10 backdrop-blur-md text-[#c5a059] shadow-lg transition-all hover:scale-110 hover:bg-[#d4af37] hover:text-white active:scale-95 md:left-6 md:h-12 md:w-12 md:top-34"
      >
